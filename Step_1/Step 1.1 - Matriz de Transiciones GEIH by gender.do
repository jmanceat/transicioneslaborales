...
*                 Step 2.1 - Matriz de Transiciones GEIH by gender 		       *

********************************************************************************
********************************************************************************

/*
				* Creación: 	 04/Jul/2021
...
* Rutas de las bases de datos 
	...
	log using "${logs}/Step 2.1 - Matriz de Transiciones GEIH by age.smcl", replace 
...
tab SEXO, matcell(gender)
local female=gender[2,1]/r(N)
...
local mujeres = round(r(N)*`female')

gen SEXO = 1 
replace SEXO = 2 in 1/`mujeres'

tab SEXO
save "${rawdata}/Vitales/nac2020.dta", replace // Esta base es temporal mientras el Dane publica los resultados de 2021
...
/*
local years "2021" // "2013 2014 2015 2016 2017 2018 2019" // 2020 2021"
...
save "$data/Transiciones/Transiciones_``mes''_`prior'_`y'_`g'.dta", replace 
...
use "$data/Transiciones/Transiciones_Febrero_2011_2012_`g'.dta", replace

local mes "Marzo Abril Mayo Junio Julio Agosto Septiembre Octubre Noviembre Diciembre"

foreach m of local mes {
	
append using "$data/Transiciones/Transiciones_`m'_2011_2012_`g'.dta", force
...
save "$data/Transiciones/Transiciones_before_2012_`g'.dta", replace 
...
use "$data/Transiciones/Transiciones_Enero_2011_2012_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2012_Enero) nogen
...
save "$data/Transiciones/Transiciones_Enero_2011_2012_`g'.dta", replace 


use "$data/Transiciones/Transiciones_Diciembre_2010_2011_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2011_Diciembre) nogen
...
save "$data/Transiciones/Transiciones_Diciembre_2010_2011_`g'.dta", replace 



use "$data/Transiciones/Transiciones_Noviembre_2010_2011_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2011_Noviembre) nogen

rename emi_2011_Noviembre emi

save "$data/Transiciones/Transiciones_Noviembre_2010_2011_`g'.dta", replace 


use "$data/Transiciones/Transiciones_Octubre_2010_2011_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2011_Octubre) nogen
...
save "$data/Transiciones/Transiciones_Octubre_2010_2011_`g'.dta", replace 


use "$data/Transiciones/Transiciones_Septiembre_2010_2011_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2011_Septiembre) nogen
...
save "$data/Transiciones/Transiciones_Septiembre_2010_2011_`g'.dta", replace 



use "$data/Transiciones/Transiciones_Agosto_2010_2011_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2011_Agosto) nogen
...
save "$data/Transiciones/Transiciones_Agosto_2010_2011_`g'.dta", replace 



use "$data/Transiciones/Transiciones_Julio_2010_2011_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2011_Julio) nogen
...
save "$data/Transiciones/Transiciones_Julio_2010_2011_`g'.dta", replace 



use "$data/Transiciones/Transiciones_Junio_2010_2011_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2011_Junio) nogen
...
save "$data/Transiciones/Transiciones_Junio_2010_2011_`g'.dta", replace 


use "$data/Transiciones/Transiciones_Mayo_2010_2011_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2011_Mayo) nogen
...
save "$data/Transiciones/Transiciones_Mayo_2010_2011_`g'.dta", replace 



use "$data/Transiciones/Transiciones_Abril_2010_2011_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2011_Abril) nogen
...
save "$data/Transiciones/Transiciones_Abril_2010_2011_`g'.dta", replace 


use "$data/Transiciones/Transiciones_Marzo_2010_2011_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2011_Marzo) nogen
...
save "$data/Transiciones/Transiciones_Marzo_2010_2011_`g'.dta", replace 


use "$data/Transiciones/Transiciones_Febrero_2010_2011_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2011_Febrero) nogen
...
save "$data/Transiciones/Transiciones_Febrero_2010_2011_`g'.dta", replace 



use "$data/Transiciones/Transiciones_Enero_2010_2011_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2011_Enero) nogen
...
save "$data/Transiciones/Transiciones_Enero_2010_2011_`g'.dta", replace 
...
use "$data/Transiciones/Transiciones_Diciembre_2009_2010_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2010_Diciembre) nogen
...
save "$data/Transiciones/Transiciones_Diciembre_2009_2010_`g'.dta", replace 



use "$data/Transiciones/Transiciones_Noviembre_2009_2010_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2010_Noviembre) nogen

rename emi_2010_Noviembre emi

save "$data/Transiciones/Transiciones_Noviembre_2009_2010_`g'.dta", replace 


use "$data/Transiciones/Transiciones_Octubre_2009_2010_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2010_Octubre) nogen
...
save "$data/Transiciones/Transiciones_Octubre_2009_2010_`g'.dta", replace 


use "$data/Transiciones/Transiciones_Septiembre_2009_2010_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2010_Septiembre) nogen
...
save "$data/Transiciones/Transiciones_Septiembre_2009_2010_`g'.dta", replace 



use "$data/Transiciones/Transiciones_Agosto_2009_2010_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2010_Agosto) nogen
...
save "$data/Transiciones/Transiciones_Agosto_2009_2010_`g'.dta", replace 



use "$data/Transiciones/Transiciones_Julio_2009_2010_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2010_Julio) nogen
...
save "$data/Transiciones/Transiciones_Julio_2009_2010_`g'.dta", replace 



use "$data/Transiciones/Transiciones_Junio_2009_2010_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2010_Junio) nogen
...
save "$data/Transiciones/Transiciones_Junio_2009_2010_`g'.dta", replace 


use "$data/Transiciones/Transiciones_Mayo_2009_2010_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2010_Mayo) nogen
...
save "$data/Transiciones/Transiciones_Mayo_2009_2010_`g'.dta", replace 



use "$data/Transiciones/Transiciones_Abril_2009_2010_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2010_Abril) nogen
...
save "$data/Transiciones/Transiciones_Abril_2009_2010_`g'.dta", replace 


use "$data/Transiciones/Transiciones_Marzo_2009_2010_`g'.dta", replace

drop emi 
 
cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2010_Marzo) nogen
...
save "$data/Transiciones/Transiciones_Marzo_2009_2010_`g'.dta", replace 


use "$data/Transiciones/Transiciones_Febrero_2009_2010_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2010_Febrero) nogen
...
save "$data/Transiciones/Transiciones_Febrero_2009_2010_`g'.dta", replace 



use "$data/Transiciones/Transiciones_Enero_2009_2010_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2010_Enero) nogen
...
save "$data/Transiciones/Transiciones_Enero_2009_2010_`g'.dta", replace 
...
use "$data/Transiciones/Transiciones_Diciembre_2008_2009_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2009_Diciembre) nogen
...
save "$data/Transiciones/Transiciones_Diciembre_2008_2009_`g'.dta", replace 



use "$data/Transiciones/Transiciones_Noviembre_2008_2009_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2009_Noviembre) nogen

rename emi_2009_Noviembre emi

save "$data/Transiciones/Transiciones_Noviembre_2008_2009_`g'.dta", replace 


use "$data/Transiciones/Transiciones_Octubre_2008_2009_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2009_Octubre) nogen
...
save "$data/Transiciones/Transiciones_Octubre_2008_2009_`g'.dta", replace 


use "$data/Transiciones/Transiciones_Septiembre_2008_2009_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2009_Septiembre) nogen
...
save "$data/Transiciones/Transiciones_Septiembre_2008_2009_`g'.dta", replace 



use "$data/Transiciones/Transiciones_Agosto_2008_2009_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2009_Agosto) nogen
...
save "$data/Transiciones/Transiciones_Agosto_2008_2009_`g'.dta", replace 



use "$data/Transiciones/Transiciones_Julio_2008_2009_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2009_Julio) nogen
...
save "$data/Transiciones/Transiciones_Julio_2008_2009_`g'.dta", replace 



use "$data/Transiciones/Transiciones_Junio_2008_2009_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2009_Junio) nogen
...
save "$data/Transiciones/Transiciones_Junio_2008_2009_`g'.dta", replace 


use "$data/Transiciones/Transiciones_Mayo_2008_2009_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2009_Mayo) nogen
...
save "$data/Transiciones/Transiciones_Mayo_2008_2009_`g'.dta", replace 



use "$data/Transiciones/Transiciones_Abril_2008_2009_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2009_Abril) nogen
...
save "$data/Transiciones/Transiciones_Abril_2008_2009_`g'.dta", replace 


use "$data/Transiciones/Transiciones_Marzo_2008_2009_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2009_Marzo) nogen
...
save "$data/Transiciones/Transiciones_Marzo_2008_2009_`g'.dta", replace 


use "$data/Transiciones/Transiciones_Febrero_2008_2009_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2009_Febrero) nogen
...
save "$data/Transiciones/Transiciones_Febrero_2008_2009_`g'.dta", replace 



use "$data/Transiciones/Transiciones_Enero_2008_2009_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2009_Enero) nogen
...
save "$data/Transiciones/Transiciones_Enero_2008_2009_`g'.dta", replace 
...
use "$data/Transiciones/Transiciones_Diciembre_2007_2008_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2008_Diciembre) nogen
...
save "$data/Transiciones/Transiciones_Diciembre_2007_2008_`g'.dta", replace 



use "$data/Transiciones/Transiciones_Noviembre_2007_2008_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2008_Noviembre) nogen

rename emi_2008_Noviembre emi

save "$data/Transiciones/Transiciones_Noviembre_2007_2008_`g'.dta", replace 


use "$data/Transiciones/Transiciones_Octubre_2007_2008_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2008_Octubre) nogen
...
save "$data/Transiciones/Transiciones_Octubre_2007_2008_`g'.dta", replace 


use "$data/Transiciones/Transiciones_Septiembre_2007_2008_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2008_Septiembre) nogen
...
save "$data/Transiciones/Transiciones_Septiembre_2007_2008_`g'.dta", replace 



use "$data/Transiciones/Transiciones_Agosto_2007_2008_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2008_Agosto) nogen
...
save "$data/Transiciones/Transiciones_Agosto_2007_2008_`g'.dta", replace 



use "$data/Transiciones/Transiciones_Julio_2007_2008_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2008_Julio) nogen
...
save "$data/Transiciones/Transiciones_Julio_2007_2008_`g'.dta", replace 



use "$data/Transiciones/Transiciones_Junio_2007_2008_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2008_Junio) nogen
...
save "$data/Transiciones/Transiciones_Junio_2007_2008_`g'.dta", replace 


use "$data/Transiciones/Transiciones_Mayo_2007_2008_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2008_Mayo) nogen
...
save "$data/Transiciones/Transiciones_Mayo_2007_2008_`g'.dta", replace 



use "$data/Transiciones/Transiciones_Abril_2007_2008_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2008_Abril) nogen
...
save "$data/Transiciones/Transiciones_Abril_2007_2008_`g'.dta", replace 


use "$data/Transiciones/Transiciones_Marzo_2007_2008_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2008_Marzo) nogen
...
save "$data/Transiciones/Transiciones_Marzo_2007_2008_`g'.dta", replace 


use "$data/Transiciones/Transiciones_Febrero_2007_2008_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2008_Febrero) nogen
...
save "$data/Transiciones/Transiciones_Febrero_2007_2008_`g'.dta", replace 



use "$data/Transiciones/Transiciones_Enero_2007_2008_`g'.dta", replace

drop emi 

cap drop _merge 

merge 1:1 Origen_Destino using "$data/Transiciones/Transiciones_before_2012_`g'.dta", keepusing(emi_2008_Enero) nogen 
...
save "$data/Transiciones/Transiciones_Enero_2007_2008_`g'.dta", replace 
