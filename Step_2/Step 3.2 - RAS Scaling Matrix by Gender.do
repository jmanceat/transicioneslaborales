...
*                     Step 3.1 - RAS Scaling Matrix by Gender      			   *
...
* Rutas de las bases de datos 
	...
	log using "${logs}/Step 3 - RAS Scaling Matrix by Gender.smcl", replace 
...
use "$data/Transiciones/Transiciones_``mes''_`prior'_`y'_`temp'.dta", clear 
...
save "$data/Transiciones/RAS_Output/`g'/transition_matrix_``mes''_`prior'_`y'_`g'.dta", replace 
...
save "$data/Transiciones/RAS_Output/`g'/transition_rate_``mes''_`prior'_`y'_`g'.dta", replace 
...
save "$data/temp/Transiciones/Transiciones_``mes''_`prior'_`y'_`g'.dta", replace 
