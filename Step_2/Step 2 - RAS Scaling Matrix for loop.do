...
*                     Step 3 - RAS Scaling Matrix for Loop      			   *
...
* Rutas de las bases de datos 
	...
	log using "${logs}/Step 3 - RAS Scaling Matrix for Loop.smcl", replace 
...
local years  "2008 2009 2010 2011 2012 2013 2014 2015 2016 2017 2018 2019 2020" // "2021"
...
use "$data/Transiciones/Transiciones_``mes''_`prior'_`y'.dta", clear 
...
save "$data/Transiciones/RAS_Output/All/transition_matrix_``mes''_`prior'_`y'.dta", replace 
...
save "$data/Transiciones/RAS_Output/All/transition_rate_``mes''_`prior'_`y'.dta", replace 
...
save "$data/temp/Transiciones/Transiciones_``mes''_`prior'_`y'.dta", replace 
