...
*                     Step 3.1 - RAS Scaling Matrix by Age      			   *

********************************************************************************
********************************************************************************

/*
				* Creacion: 	13/Mar/2021
				* Autor:		Nicolas Mancera 
				* Modificacion: 02/Jun/2021
*/
...
* Rutas de las bases de datos 
	...
	log using "${logs}/Step 3 - RAS Scaling Matrix by Age.smcl", replace 
...
use "$data/Transiciones/Transiciones_``mes''_`prior'_`y'_`age'_`age_plus'.dta", clear 
...
seednico2 Freq Total_`prior' Total_`y' , by(Origen Destino)  tolerance(80)  generate(result_constraint)
...
save "$data/Transiciones/RAS_Output/`age'_`age_plus'/transition_matrix_``mes''_`prior'_`y'_`age'_`age_plus'.dta", replace 
...
save "$data/Transiciones/RAS_Output/`age'_`age_plus'/transition_rate_``mes''_`prior'_`y'_`age'_`age_plus'.dta", replace 
...
save "$data/temp/Transiciones/Transiciones_``mes''_`prior'_`y'_`age'_`age_plus'.dta", replace 
